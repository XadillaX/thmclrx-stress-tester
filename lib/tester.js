...
exports.test = function() {
    // delete previous
    run("rm -rf " + __dirname + "/../result/*.html");
    ...
    walker.on("file", function(root, fileStats, next) {
        ...
        thmclrx.mixed(root + "/" + fileStats.name, 16, palette, function(err, result) {
            var endTime = moment();
    ...
    walker.on("end", function() {
        var str = "Finished " + fileCount + " pictures for " + (timeCount / 1000).format(5) + " s.";
        console.log(str);
